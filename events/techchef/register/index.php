    ...
    <div class="hover_bkgr_fricc" style="display: block;">
        ...
        <?php
            // echo date('d/m/y h:i:sa',time()); 
             echo "<p><strong>Registrations are closed!<hr></strong><br>Registration link is closed for now.<br>We will come back with another exciting event soon.</p>";
             ?>              
